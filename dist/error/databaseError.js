...
var DatabaseError = function (_Error) {
    ...
    function DatabaseError(errorMessage) {
        ...
        var _this = _possibleConstructorReturn(this, (DatabaseError.__proto__ || Object.getPrototypeOf(DatabaseError)).call(this, '[DATABASE]: ' + errorMessage));

        _this.type = 'DATABASE_ERROR';
